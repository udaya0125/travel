...
const AddDestinationForm = ({
    ...
    const [submitting, setSubmitting] = useState(false);
    // Single image only, mirroring how the backend `store`/`update`
    // endpoints accept just one `image` file per destination.
            ...
            >
                ...
                >
                    ...
                    <section>
                        ...
                        <p className="text-xs text-gray-400 mt-1">
                            Max {MAX_IMAGE_SIZE_MB}MB. One image per destination.
                        </p>
